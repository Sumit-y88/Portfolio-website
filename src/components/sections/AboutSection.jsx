...
export const AboutSection = () => (
  <section id="aboutme" className="relative scroll-mt-28 overflow-hidden py-24">
    ...
    <div className="relative mt-16 grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
      ...
      <div data-about-right className="about-flow-panel relative overflow-hidden p-6">
